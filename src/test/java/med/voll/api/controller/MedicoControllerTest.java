...
class MedicoControllerTest {
    ...
    @Test
    @DisplayName("Deveria dovolver codigo http 400 quando informacoes estao invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria dovolver codigo http 201 quando informacoes estao validas")
    @WithMockUser
